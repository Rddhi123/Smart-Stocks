...
class Login_System:
    def __init__(self,root):
        ...
        # #===images=======
        # self.ims_image=ImageTk.PhotoImage(file="Users\User\Downloads\pbl\image1.jpg")
        # self.lbl_ims_image=Label(self.root,image=self.ims_image,bd=0).place(x=200,y=50)
    ...
    def forget_window(self):
         ...
         try:
            ...
            if email==None:
                ...
                lbl_reset=Label(self.forget_win,text="Enter OTP on Registered Email",font=("times new roman",15)).place(x=20,y=60)
                txt_reset=Entry(self.forget_win,textvariable=self.var_otp,font=("times new roman",15),bg='lightyellow').place(x=20,y=100,width=250,height=30)
                self.btn_reset=Button(self.forget_win,text="SUBMIT",font=("times new roman",15),bg='lightblue')
                self.btn_reset.place(x=28,y=100,width=250,height=30)
                
                lbl_new_pass=Label(self.forget_win,text="New Password",font=("times new roman",15)).place(x=20,y=60)
